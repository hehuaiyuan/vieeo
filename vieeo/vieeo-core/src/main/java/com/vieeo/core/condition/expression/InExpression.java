...
public class InExpression extends HqlExpression {
	...
	public InExpression(String propertyName,Object[] values,ConditionEnum type){
	...
	public boolean check() {
		return (StringUtils.isBlank(propertyName) || (values == null || values.length<=0 ))? false : true ;
	}
