...
public enum ErrorCodeEnums1 {
	...
	ErrorCodeEnums1(String code, String name,String displayName) {
		this.code = code;
		this.name = name;
	...
	public static ErrorCodeEnums1 getByCode(String code) {
		for (ErrorCodeEnums1 errorType : ErrorCodeEnums1.values()) {
