...
class TestSign2 {
	...
	public void test() {
		...
		String traceNo = "838e6f8a-9d9e-49f0-8243-2f54fc7ae6db";
		String version =  "V4.1.2.1.1";
		String sendTime = "20140616101730";
		//Body
		//订单金额
		String orderAmount = "50.00";
		//商户订单号
		String orderNo = "20140616101643-000005-8786-1";
		String instCode = "OC";
		String paymentNo = "CP20140616101653227409";
		//实际支付金额
		String transAmount = "0.00";
		//盛付通卡网关订单号
		String transNo = "C20140616101643690621";
		//订单状态
		String transStatus = "02";
		//订单支付时间
		String transTime = "20140616101643";
		...
		String errorMsg = "[{\"cardNo\":\"14541310274870659\",\"errorCode\":\"F1039\",\"errorMsg\":\"卡号或者卡密不正确，请确认后重新输入\"}]";
		//Ext
		String ext1 = "";
		String ext2 = "";
		//Sign
		String signType = "MD5";
		String signMsg = "285DAB747CC07CC643512CD95C77D844";
