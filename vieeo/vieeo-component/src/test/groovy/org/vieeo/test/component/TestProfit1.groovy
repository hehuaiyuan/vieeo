...
class TestProfit1 {
	...
	public void test() {
		...
		BufferedReader reader2 = new File("D:\\新建文件夹\\profit_rule\\yc.txt").newReader('utf-8');
		reader2.eachLine {line ->
			...
			String values495887YCFROM = " VALUES(TO_CHAR (SYSDATE, 'yyyymmdd') || PPCPROFIT.SEQ_PROFIT_RULE_FEE_SPEC.NEXTVAL,'$cardYC',$kind,'$role',${ids.get(line)},'[$line]${names.get(line)}','$profitType',$profitValueYDFROM,'$realRole','$merchant2','$merchant2$merchant2Name','$profitType',0,$validDate,null,null,null,SYSDATE,SYSDATE,1,'YD卡特殊分润政策-新增加外部中凯类商户-20131223')";
