...
public class DebitChannelService extends
        AbstractChannelService<String, ChannelFundRequest, DebitRequest, DebitResponse, ChannelFundResult> {
    ...
    private ChannelProcessor<DebitRequest, DebitResponse> channelProcessor;
    ...
    @Override
    protected DebitRequest convert(ChannelFundRequest request, FundChannel fundChannel) throws Exception {
        return null;
    }

    @Override
    protected ChannelProcessor<DebitRequest, DebitResponse> getChannelProcessor(DebitRequest channelDomain,
            FundChannel fundChannel) {
        return channelProcessor;
    }

    @Override
    protected ChannelFundResult toResponse(DebitRequest channelDomain, DebitResponse channelResponse) throws Exception {
        return null;
    }
