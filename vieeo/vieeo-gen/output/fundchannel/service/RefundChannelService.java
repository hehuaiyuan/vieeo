 ...
 */
@Component("ccbRefundChannelService")
public class RefundChannelService extends
        AbstractChannelService<String, ChannelFundRequest, RefundRequest, RefundResponse, ChannelFundResult> {
    ...
    @Resource(name="ccbRefundProcessor")
    private ChannelProcessor<RefundRequest, RefundResponse> channelProcessor;
    ...
    @Override
    protected RefundRequest convert(ChannelFundRequest request, FundChannel fundChannel) throws Exception {
        return null;
    }

    @Override
    protected ChannelProcessor<RefundRequest, RefundResponse> getChannelProcessor(RefundRequest channelDomain,
            FundChannel fundChannel) {
        return channelProcessor;
    }

    @Override
    protected ChannelFundResult toResponse(RefundRequest channelDomain, RefundResponse channelResponse) throws Exception {
        return null;
    }
